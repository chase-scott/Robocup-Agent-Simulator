...
//
//***************************************************************************
public class Krislet implements SendCommand, Runnable
{

	public Krislet(String[] a, Env env) throws SocketException, IOException {
    //===========================================================================
	...
	try
		...
		m_host = InetAddress.getByName(hostName);
		m_port = port;
		m_team = team;
		m_playing = true;
	...
	//---------------------------------------------------------------------------
	// This function updates percept information to inform the environment
	public void updatePercepts(String[] m_percepts) {

		this.m_environment.updatePercepts(m_percepts);
	...
	private Env 			m_environment;				// contains Jason reasoning engine
